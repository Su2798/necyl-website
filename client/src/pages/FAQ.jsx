      ...
      <div className="container mx-auto max-w-3xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 mt-6 text-lg">
            Have questions? We've compiled the most common inquiries to help you
            get started.
          </p>
        </div>
        ...
        <div className="space-y-6">
          {faqList.map((faq, index) => (
            ...
            >
              ...
              >
                <span
                  className={`text-xl font-bold ${openIndex === index ? "text-blue-950" : "text-blue-900"}`}
                >
                  {faq.q}
                </span>
                <ChevronDown
              ...
              >
                <p className="px-8 pb-6 text-gray-700 leading-relaxed text-lg faq-answer-text">
                  {faq.a}
                </p>
              </div>
            </div>
